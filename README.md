...
A batch scripts to automatically activate virtual environment when using [Python Virtualenv]([https://github.com/pyenv/pyenv](https://pypi.org/project/virtualenv/) when entering working directory in windows command prompt.
